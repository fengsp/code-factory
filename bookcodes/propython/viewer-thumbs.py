...
creation; to do: add scolling if too many thumbs for window!
"""
...
def makeThumbs(imgdir, size=(100,100), subdir='thumbs'):
	"""
	get thumbnail images for all images in one directory; for each image, create
	...
	caller can also run listdir on thum dir to load; on bad file types may
