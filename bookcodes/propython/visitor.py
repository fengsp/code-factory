...
class FileVisitor:
	"""
	Visits all nondirectory files below startDir;
	ovveride visit* method to provide custom file handlers;
	context arg/attribute is optional subclass-specific states;
...
class SearchVisitor(FileVisitor):
	...
	subclass: redefine visitmatch, extension lists, candidata as needed;
